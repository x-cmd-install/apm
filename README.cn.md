...
合计: **674,987** 行代码（覆盖前 5 种语言、共 **2096** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Python | 627,360 | 34,663 | 121,835 | 1882 |
| Json | 27,452 | 0 | 0 | 50 |
| Sh | 5,247 | 1,100 | 886 | 35 |
| Yaml | 4,867 | 292 | 72 | 110 |
| JavaScript | 3,722 | 226 | 519 | 19 |

## 源代码

- **上游仓库**: <https://github.com/microsoft/apm>
...
- **Star**: 3,779 · **Fork**: 360 · **开放 issue**: 1,263 · **贡献者**: 111

## 累计统计

- **发布数**: 77 · **已合并 PR**: 1235 · **开放 PR**: 63 · **已关闭 issue**: 1124 · **开放 issue**: 139 · **提交数**: 1967

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 3 | 138 | 46 | 118 | 50 | 195 |
| last60d | 2026-07-14 | 6 | 274 | 50 | 265 | 73 | 355 |
| 90d | 2026-06-14 | 13 | 442 | 56 | 433 | 110 | 521 |
| last180d | 2026-03-16 | 49 | 1088 | 63 | 980 | 137 | 1201 |
| 360d | 2025-09-17 | 77 | 1235 | 63 | 1115 | 139 | 1675 |
| last720d | 2024-09-22 | 77 | 1235 | 63 | 1115 | 139 | 1967 |
...
在 [repology.org](https://repology.org/project/apm) 上共有 **6** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**3** 个 ⚠️ 使用旧版本。
...
apm 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `apm` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/apm.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T02:39:44Z._
